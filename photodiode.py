...
def analysePD(wildcard, whiteThreshold=.8):
  '''
    ...
    whiteThreshold:      a number between 0 and 1, although the code is not checking for it and any number will make the code work.
                         whtie frames are defined as any crossing of thresholdm where threshold is whiteTrheshold*maxValueInRecording
